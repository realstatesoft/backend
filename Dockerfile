...
ENTRYPOINT ["sh", "-c", "java -Xmx300m -Xms200m -Xss512k -XX:MaxMetaspaceSize=160m -XX:+UseContainerSupport -Djava.security.egd=file:/dev/./urandom -Dserver.port=${PORT:8080} -jar app.jar"]
