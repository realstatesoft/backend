...
ENTRYPOINT ["sh", "-c", "java -Xmx256m -Xms128m -Xss512k -XX:MaxMetaspaceSize=128m -XX:ActiveProcessorCount=1 -XX:+ExitOnOutOfMemoryError -XX:+UseContainerSupport -Djava.security.egd=file:/dev/./urandom -Dserver.port=${PORT:8080} -jar app.jar"]
