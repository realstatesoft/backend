...
public record CreatePropertyRequest(
        ...
        // ─── Información básica ───────────────────────────────────────
        @NotBlank(message = "El título es obligatorio") @Size(max = 255, message = "El título no puede exceder 255 caracteres") String title,

        String description,

        @NotNull(message = "El tipo de propiedad es obligatorio") PropertyType propertyType,
        ...
        @MaxDigits(integer = 20) @NotNull(message = "El precio es obligatorio") @Positive(message = "El precio debe ser mayor a 0") BigDecimal price,
        ...
        // ─── Relaciones ───────────────────────────────────────────────
        @NotNull(message = "El propietario es obligatorio") Long ownerId,
